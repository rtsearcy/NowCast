...
outfolder = 'S:\SCIENCE & POLICY\\NowCast\Daily files\winter_2018_2019\data\\tide'
# To use for setting up daily run folder

sd = '20180931'  # Start date (account for previous day, conservative)
ed = '20190331'  # End date
